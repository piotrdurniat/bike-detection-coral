...
def get_output(interpreter, score_threshold, image_scale=(1.0, 1.0), classes=[1]):
    ...
    return [make(i) for i in range(count) if scores[i] >= score_threshold and class_ids[i] in classes]
